...
FrothFET is fully open source, so you can order and assemble the PCB yourself. The easiest way to do this is through [JLCPCB](https://jlcpcb.com), which supports ordering fully assembled boards directly from our design files.
