...
[Details on how to get FrothFET here](/docs/hardware/where-to-buy)

## Revisions

- [Revision F](/docs/hardware/revision-f) — latest version
...
All hardware design files (schematics, gerbers, and BOM) are available on [GitHub](https://github.com/hoeken/frothfet).
